...
//
// function NawtData({ reservationDetails }) {
...
//             // Voeg hier de tariefinformatie toe
...
//                 setSuccessMessage("E-mail succesvol verzonden!"); // Toon succesmelding
//             })
//             .catch((err) => {
//                 console.error("E-mail verzenden mislukt", err);
//                 setErrorMessage("Er is een fout opgetreden bij het verzenden van de e-mail."); // Toon foutmelding
//             });
//     };
//
//     return (
...
//                 {successMessage && <p style={{ color: "green" }}>{successMessage}</p>} {/* Succesmelding */}
...
//                 <button className="nawt-data-button" type="submit">Verstuur</button>
//             </form>
//         </div>
//     );
// }
